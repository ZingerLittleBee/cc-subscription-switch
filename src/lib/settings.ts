...
const ACCOUNT_SPECIFIC_FIELDS = ['accountId', 'userId', 'email', 'oauthAccount', 'primaryOrganization', 'env']
...
export async function loadAccountSettings(accountDir: string): Promise<ClaudeSettings | null> {
  try {
...
export async function saveAccountSettings(accountDir: string, settings: ClaudeSettings): Promise<void> {
...
export async function saveCommonSettings(settings: ClaudeSettings): Promise<void> {
